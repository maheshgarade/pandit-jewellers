...
const GoldReceipt: React.FC<GoldReceiptProps> = ({ calculations }) => {
  return (
    <Card className="p-5 shadow-lg border-purple-200 bg-white relative overflow-hidden">
      ...
      <div className="relative z-10">
        <div className="text-center mb-5">
          <h2 className="text-xl font-bold bg-gradient-to-r from-purple-600 via-pink-500 to-rose-500 bg-clip-text text-transparent">Gold Jewelry Bill</h2>
        ...
        <div className="space-y-3">
          <div className="bg-gradient-to-r from-purple-100 to-pink-100 p-2.5 rounded-md">
            <div className="flex justify-between text-sm">
              ...
              <span className="text-purple-800">{calculations.purity} ({calculations.purityPercentage}%)</span>
            </div>
          </div>

          <div className="bg-gradient-to-r from-pink-100 to-rose-100 p-2.5 rounded-md">
            <div className="flex justify-between text-sm">
              <span className="font-medium text-purple-900">Net Gold Weight</span>
              <span className="text-purple-800">{calculations.netGoldWeight} g</span>
            </div>
          </div>
          ...
          <div className="space-y-2.5 px-1">
            <div className="flex justify-between text-sm">
              ...
              <span className="text-purple-700">₹ {calculations.goldPrice}</span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="text-gray-600">Making Charges</span>
              <span className="text-purple-700">₹ {calculations.makingChargesAmount}</span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="text-gray-600">Stone Charges</span>
              <span className="text-purple-700">₹ {calculations.stoneCharges}</span>
            </div>
          </div>
